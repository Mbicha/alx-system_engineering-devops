...
+ What a server is.<br/>A server is a computer or a device that that
provides a service to another computer, called *client*. Client is a user who access the website through a computer.
